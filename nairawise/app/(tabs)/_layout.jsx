...
import { Home, Receipt, Plus, PieChart, Settings, Building2Icon } from 'lucide-react-native';
import { useTheme } from '../../src/theme/ThemeContext';
import VoiceQuickAdd from '../../src/components/VoiceQuickAdd';
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      >
        ...
        <Tabs.Screen
          name="budget"
          options={{ title: 'Budget', tabBarIcon: ({ color, size }) => <Building2Icon color={color} size={size} /> }}
        />
        <Tabs.Screen
          name="settings"
          options={{ title: 'Settings', tabBarIcon: ({ color, size }) => <Settings color={color} size={size} /> }}
